                                                        ...
                                                        <tbody>
                                                            @foreach ($orders as $order)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ number_format(num: $order->total_price, decimals: 0, decimal_separator: ',', thousands_separator: '.') }} đ
                                                                    </td>
                                                                    <td><a href="{{ route('order.show', $order->id) }}" class="btn btn-sm btn-info">Xem chi
                                                                            tiết</a></td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
